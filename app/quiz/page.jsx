...
const Page = () => {
    ...
    const onAnswerSelected = (idx) => {
        if (questions[activeQuestion].id === 6) {
            ...
            setSelectedAnswerIndices((prev) =>
                prev.includes(idx)
                    ? prev.filter((i) => i !== idx)
                    : [...prev.filter((i) => answers[i].toLowerCase() !== 'none of the above'), idx]
            );
        }
    };
    ...
    const nextQuestion = () => {
        if ((answers[0] === '' && questions[activeQuestion].id !== 6) || (questions[activeQuestion].id === 6 && showInputField)) {
                ...
                {!showResult ? (
                    <div className="quiz-container">
                        ...
                        {questions[activeQuestion].id === 6 ? (
                            ...
                            <>
                                {(answers[0] === '' && questions[activeQuestion].id !== 6) || showInputField ? (
                                    <>
                                        <ul className="user-answers-list">
                                            {userAnswers.map((answer, idx) => (
                                                <li
                        ...
                        <div className="button-group">
                            ...
                            <button
                                ...
                                disabled={selectedAnswerIndices.length === 0 && userAnswers.length === 0}
                            >
